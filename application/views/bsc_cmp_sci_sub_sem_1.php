...
<div class="content">
	 <div class="gadget">
       	<div class="titlebar vertsortable_head">
			<h3 align="center">Stream : B.S.C. (C.S)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Semester : 1</h3>
		</div>
	...
	<tr>
		...
		<div id="content-table-inner">
			...
			<?php echo form_open('home/saveBscCmpStudentDetail',$form_data); $js ='class="my_select"'; ?>
		
			<input type="hidden" value="<?php echo "bsc_cmp_sci_sub_sem_1"; ?>" name="view_name" />
			<input type="hidden" value="<?php echo "bsc_cmp_sci_student_detail_sem_1"; ?>" name="tbl_name" />
...
<script type="text/javascript">
	...
	$('#reg').change(function(){
		...
		$.post(url,{input:$('#reg').val(),stream2:'bsc_cmp_sci_student_detail_sem_1',type:$('input:radio[name=type]:checked').val()},function(data){
			//$('#status').html(data);
			var status=data;
