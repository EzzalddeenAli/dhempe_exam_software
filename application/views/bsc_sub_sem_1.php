	...
	<tr>
		...
		<div id="content-table-inner">
			...
			<div id="table-content">				
				...
				<input type="hidden" value="<?php echo "bsc_sub_sem_1" ?>" name="view_name" />
...
<script type="text/javascript">
	...
	$('#reg').change(function(){
		...
		$.post(url,{input:$('#reg').val(),stream2:'bsc_student_detail_sem_1',type:$('input:radio[name=type]:checked').val()},function(data){
			//$('#status').html(data);
			var status=data;
