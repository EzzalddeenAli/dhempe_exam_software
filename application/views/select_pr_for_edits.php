...
<div class="content">
	...
	<tr>
		...
		<?php echo form_open('home/gen_2012',$form_id); $js ='class="my_select"'; ?>
...
<script type="text/javascript">
	...
	$('#back').click(function(){
		window.location='<?php echo base_url(); ?>index.php/final_marksheet/print_marksheet';
	});
	...
	$('#search').keyup(function(){
		...
		var url='<?php echo base_url()."/index.php/home/searchBoxs"; ?>';
