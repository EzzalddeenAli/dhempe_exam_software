...
<?php 
	...
	$subject7=array(
		...
		"7A1"=>"Accounting-III",
		"7A2"=>"Rural Marketing",
		"7A3"=>"Distribution & Retail Management",
		"7A4"=>"Advertising",
...
<div class="content">
	 <div class="gadget">
       	<div class="titlebar vertsortable_head">
			<h3 align="center">Stream : B.COM&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Semester : 3</h3>
		</div>
		<div class="gadgetblock">
			<?php $form_data=array('name'=>"myForm","id"=>"formData"); ?>
			<?php echo form_open('home/saveBcomStudentDetail',$form_data); ?>
		
			<input type="hidden" value="<?php echo  "bcom_sub_sem_3"; ?>" name="view_name" />
			<input type="hidden" value="<?php echo  "bcom_student_detail_sem_3"; ?>" name="tbl_name" />
			...
			<ol>
				...
				<li>
					...
					<div style="margin-top:20px;">
						...
						<div style="float:left; margin-left:20px;">
							Indian Financial System<?php echo form_radio('subject3','3A','TRUE'); ?>
						</div>
						<div style="float:left; margin-left:20px;">
							Business laws<?php echo form_radio('subject4','4A','TRUE'); ?>
						</div>
						<div style="float:left; margin-left:20px;">
							Financial Accounting- III<?php echo form_radio('subject5','5A','TRUE'); ?>
						</div>
						<div style="float:left; margin-left:20px;">
...
<script type="text/javascript">
	...
	$('#reg').change(function(){
		...
		$.post(url,{input:$('#reg').val(),stream2:'bcom_student_detail_sem_3'},function(data){
			//$('#status').html(data);
			var status=data;
			if(status == 0){
