...
<div class="content">
	...
	<tr>
		...
		<input type="hidden" value="<?php echo  "ba_sub_sem_4"; ?>" name="view_name" />
		...
		<input type="hidden" value="700" name="MaxaggMark" />
            ...
            <li>
				...
				<div style="float: left; margin-left:50px;">
					<?php $nameId=array('name'=>'Name','id'=>'name_test','class'=>'my_inp_form'); ?></h4>
					<h4>Name <?php echo form_input($nameId); ?>
				</div>
...
<script type="text/javascript">
	...
	$('#reg').change(function(){
		...
		$.post(url,{input:$('#reg').val(),stream2:'ba_student_detail_sem_4',type:$('input:radio[name=type]:checked').val()},function(data){
			//$('#status').html(data);
			var status=data;
