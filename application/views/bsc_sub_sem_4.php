...
<div class="content">
	 <div class="gadget">
       	<div class="titlebar vertsortable_head">
          	<h3 align="center">Stream : B.S.C.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Semester : 4</h3>
        </div>
	...
	<tr>
		...
		<div id="content-table-inner">
			...
			<input type="hidden" value="<?php echo "bsc_sub_sem_4" ?>" name="view_name" />
			<input type="hidden" value="<?php echo  "bsc_student_detail_sem_4"; ?>" name="tbl_name" />
...
<script type="text/javascript">
	...
	$('#reg').change(function(){
		...
		$.post(url,{input:$('#reg').val(),stream2:'bsc_student_detail_sem_4',type:$('input:radio[name=type]:checked').val()},function(data){
			//$('#status').html(data);
			var status=data;
