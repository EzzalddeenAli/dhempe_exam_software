...
<?php
	...
	if($type == 'now_eligible')
		$namePage='Newly Eligible Supplementary Students Check List';
?>
...
<div class="content">
	...
	<tr>
		...
		<?php echo form_open('final_marksheet/supple_semester_checklist/'.$typeSubmit,$form_id); $js ='class="my_select"'; $j ='class="my_button_submit"';?>
