...
<div class="content">
	 <div class="gadget">
       	<div class="titlebar vertsortable_head">
          	<h3 align="center">Stream : B.S.C.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Semester : 3</h3>
        </div>
	...
	<tr>
		...
		<div id="content-table-inner">
			...
			<?php echo form_open('home/saveBscStudent2',$form_data);  $js ='class="my_select"'; ?>
		
			<input type="hidden" value="<?php echo "bsc_sub_sem_3" ?>" name="view_name" />
			<input type="hidden" value="<?php echo  "bsc_student_detail_sem_3"; ?>" name="tbl_name" />
			...
			<ol>
				...
				<li>	
					...
					<div id="hideSports" style="display:none;">
						<div style="float:left; margin-left:20px; margin-top:-7px;">
							<h4>Category<?php echo form_dropdown('cat',$options,"", $js ='class="my_select"'); ?><h4>
						</div>
						<div style="float:left; margin-left:20px; margin-top:-7px;">
							<h4>Rewards<?php echo form_dropdown('rewards',$rewards,"", $js ='class="my_select"'); ?><h4>
						</div>
					</div>
			  	</li> 			
				...
				<li>
					...
					<div style="margin-top:20px;">
						<div style="float:left;">
							Major 1, 2 & 3 <?php echo form_dropdown('subject',$subject,"", $js ='class="my_select"'); ?>
						</div>
					</div>	
					
					<div style="clear:both;margin-top:65px;">
						<div style="float:left;">
							Foundation Course<?php echo form_radio('subject7','3A','true'); ?>
						</div>
					</div>
				</li>
				<li>
...
<script type="text/javascript">
	...
	$('#reg').change(function(){
		...
		$.post(url,{input:$('#reg').val(),stream2:'bsc_student_detail_sem_3',type:$('input:radio[name=type]:checked').val()},function(data){
			//$('#status').html(data);
			var status=data;
