...
<div class="content">
	...
	<tr>
		...
		<div id="content-table-inner">
			...
			<?php $form_id=array('id'=>'myForm'); $js ='class="my_select"'; $j ='class="my_button_submit"'; ?>
			<?php echo form_open('revalController/getPr',$form_id); ?>
					
			Stream<?php echo form_dropdown('stream',$stream,'',$js);?>    
						
			Semester<?php echo  form_dropdown('semester',$semester,'',$js) ?> 	
							
			<?php echo form_submit('submit','GET PR',$j); ?>
