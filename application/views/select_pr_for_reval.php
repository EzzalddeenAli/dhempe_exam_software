...
<table border="0" width="100%" cellpadding="0" cellspacing="0" id="content-table">
	...
	<tr>
		...
		<div id="content-table-inner">
			...
			<?php echo form_open('revalController/getMarks',$form_id); ?>
			...
			<div style="float:left; margin-left:20px; display:none;" id="no_of_attempt">
				Attempt Number
			...
			<div style="float:left;margin-left:20px;display:none;" id="supple_seat">
				Supplementary Seat Number &nbsp;&nbsp;&nbsp;<input type="text" name="supple_seat_number" id="one" />
			</div>	
