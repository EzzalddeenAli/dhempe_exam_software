...
<div class="content">
	 <div class="gadget">
       	<div class="titlebar vertsortable_head">
			<h3 align="center">Stream : B.S.C. (C.S)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Semester : 2</h3>
		</div>
	...
	<tr>
		...
		<div id="content-table-inner">
			...
			<?php echo form_open('home/saveBscCmpStudentDetail',$form_data); ?>

			<input type="hidden" value="<?php echo "bsc_cmp_sci_sub_sem_2"; ?>" name="view_name" />
			<input type="hidden" value="<?php echo "bsc_cmp_sci_student_detail_sem_2"; ?>" name="tbl_name" />
			...
			<ol>
				<li>
					...
					<div style="float: left; margin-left:50px;">
						<h4>Name <?php 
						$seat=array('name'=>"Name","id"=>"name",'class'=>'my_inp_form');
						echo form_input($seat); ?></h4>
					</div>
					<div style="float: left; margin-left:50px;">
				...
				<li>
					...
					<div style="clear:both;margin-top:65px;">
						<div style="float:left;">
			Foundation Course(Entrepreneurship Development)&nbsp;<?php echo form_radio('subject7','1','true'); ?>
						</div>
					</div>
					<div style="float:left; margin-left:20px;">
						Environmental Education&nbsp;<?php echo form_radio('subject8','','true'); ?>
					</div>
				</li>
				<li>
...
<script type="text/javascript">
	...
	$('#reg').change(function(){
		...
		$.post(url,{input:$('#reg').val(),stream2:'bsc_cmp_sci_student_detail_sem_2',type:$('input:radio[name=type]:checked').val()},function(data){
			//$('#status').html(data);
			var status=data;
