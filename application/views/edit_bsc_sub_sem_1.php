...
<div class="content">
	 	<div class="gadget">
          	<div class="titlebar vertsortable_head">
           		<h3 align="center">Stream : B.S.C. &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Semester : 1</h3>
         	</div>
	...
	<tr>
		...
		<div id="content-table-inner">
			...
			<div id="table-content">									
				...
				<?php echo form_open('home/editsaveBscStudent',$form_data);$js ='class="my_select"'; ?>
	
				<input type="hidden" value="<?php echo  "bsc_student_detail_sem_1"; ?>" name="tbl_name" />
				...
				<ol>
					...
					<h4>Fresh <?php echo form_radio('type','0',$set_type); ?>
						...
						<hr/><div style="float: left; margin-left:50px;">
					...
					<li>
						...
						<div style="margin-top:20px;">
							<div style="float:left;">
								Major 1, 2 & 3 <?php echo form_dropdown('subject',$subject,$selcted_sub,$js); ?>
							</div>
						</div>
