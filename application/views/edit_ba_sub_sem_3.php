...
<div class="content">
	 	<div class="gadget">
          	<div class="titlebar vertsortable_head">
           		<h3 align="center">Stream : B.A. &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Semester : 3</h3>
         	</div>
	...
	<tr>
		...
		<div id="content-table-inner">
			...
			<div id="table-content">									
				...
				<?php echo form_open('home/editSaveStudentDetail2',$form_data); ?>
				...
				<ol>
					...
					<h4>Fresh <?php echo form_radio('type','0',$set_type); ?>
						...
						<div style="float:left;">
							<h4>Name <?php echo form_input($data);$js ='class="my_select"'; ?></h4>
						</div>
					...
					<li>
						...
						<div style="clear:both;margin-top:40px;">
							...
							<div style="float:left; margin-left:20px;">
								Allied Paper<?php echo form_dropdown('subject5',$subject5,$sel_Sub5,$js); ?>
							</div>
							<div style="float:left; margin-left:20px;">
								Foundation Course<?php echo form_dropdown('subject6',$subject6,$sel_Sub6,$js); ?>
							</div>
							<div style="float:left; margin-left:20px;">
								Population Studies<?php echo form_dropdown('subject7',$subject7,$sel_Sub7,$js); ?>
							</div>
						</div>
						</h4>
					</li>
