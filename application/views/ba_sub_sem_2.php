	...
	<tr>
		...
		<div id="content-table-inner">
			...
			<div id="table-content">									
				...
				<input type="hidden" value="<?php echo  "ba_sub_sem_2"; ?>" name="view_name" />
				...
				<ol>
					...
					<li>	
						...
						<div style="margin-top:20px;">
							<div style="float:left;">
								Written English&nbsp;&nbsp; <?php echo form_radio('subject1','1A','TRUE'); ?>
							</div>
							<div style="float:left; margin-left:20px;">
...
<script type="text/javascript">
	...
	$('#reg').change(function(){
		...
		$.post(url,{input:$('#reg').val(),stream2:'ba_student_detail_sem_2',type:$('input:radio[name=type]:checked').val()},function(data){
			//$('#status').html(data);
			var status=data;
